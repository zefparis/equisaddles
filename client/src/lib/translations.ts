export const translations: Record<string, Record<string, string>> = {
  fr: {
    ...
    "legal.privacy.subtitle": "Equi Saddles s'engage à protéger vos données personnelles.",
    "legal.terms.title": "Conditions Générales de Vente",
    "legal.terms.subtitle": "Conditions régissant l'utilisation du site Equi Saddles et l'achat de nos produits équestres.",
    "legal.returns.title": "Retours et Échanges",
    "legal.returns.subtitle": "Politique de retour flexible d'Equi Saddles. Votre satisfaction est notre priorité.",
    ...
    "terms.products.title": "Produits et Prix",
    "terms.products.our": "Nos Produits",
    "terms.products.list1": "Selles d'équitation de haute qualité (Dressage, Obstacle, Cross, Mixte, Poney)",
    "terms.products.list2": "Accessoires et équipements équestres sélectionnés",
    "terms.products.list3": "Produits neufs exclusivement, avec garantie fabricant",
    "terms.pricing.title": "Tarification",
    "terms.pricing.list1": "Prix indiqués en euros (€), toutes taxes comprises (TTC)",
    "terms.pricing.list2": "TVA applicable : 20% (France métropolitaine)",
    "terms.pricing.list3": "Frais de livraison calculés selon destination et poids",
    "terms.pricing.list4": "Prix susceptibles de modification sans préavis",
    "terms.pricing.list5": "Prix applicable : celui en vigueur au moment de la commande",
    "terms.orders.title": "Commandes et Paiement",
    "terms.orders.process": "Processus de Commande",
    "terms.orders.step1": "Sélection des produits",
    "terms.orders.step2": "Validation du panier",
    "terms.orders.step3": "Saisie des informations",
    "terms.orders.step4": "Choix du mode de livraison",
    "terms.orders.step5": "Paiement sécurisé",
    "terms.orders.step6": "Confirmation par email",
    "terms.payment.methods": "Moyens de Paiement",
    "terms.payment.list1": "Carte bancaire (Visa, Mastercard)",
    "terms.payment.list2": "Paiement sécurisé via Stripe",
    "terms.payment.list3": "Cryptage SSL 256-bit",
    "terms.payment.list4": "Aucune donnée bancaire stockée",
    "terms.payment.list5": "Paiement en une fois uniquement",
  ...
  en: {
    ...
    "legal.privacy.subtitle": "Equi Saddles is committed to protecting your personal data.",
    "legal.terms.title": "Terms and Conditions",
    "legal.terms.subtitle": "Terms governing the use of the Equi Saddles website and the purchase of our equestrian products.",
    "legal.returns.title": "Returns and Exchanges",
    "legal.returns.subtitle": "Equi Saddles flexible return policy. Your satisfaction is our priority.",
  ...
  nl: {
    ...
    "legal.privacy.subtitle": "Equi Saddles zet zich in voor de bescherming van uw persoonlijke gegevens.",
    "legal.terms.title": "Algemene Voorwaarden",
    "legal.terms.subtitle": "Voorwaarden voor het gebruik van de Equi Saddles website en de aankoop van onze paardrijproducten.",
    "legal.returns.title": "Retouren en Ruilen",
    "legal.returns.subtitle": "Flexibel retourbeleid van Equi Saddles. Uw tevredenheid is onze prioriteit.",
  ...
  es: {
    ...
    "legal.privacy.subtitle": "Equi Saddles se compromete a proteger sus datos personales.",
    "legal.terms.title": "Términos y Condiciones",
    "legal.terms.subtitle": "Términos que rigen el uso del sitio web de Equi Saddles y la compra de nuestros productos ecuestres.",
    "legal.returns.title": "Devoluciones e Intercambios",
    "legal.returns.subtitle": "Política de devolución flexible de Equi Saddles. Su satisfacción es nuestra prioridad.",
  ...
  de: {
    ...
    "legal.privacy.subtitle": "Equi Saddles verpflichtet sich zum Schutz Ihrer persönlichen Daten.",
    "legal.terms.title": "Allgemeine Geschäftsbedingungen",
    "legal.terms.subtitle": "Bedingungen für die Nutzung der Equi Saddles Website und den Kauf unserer Reitprodukte.",
    "legal.returns.title": "Rücksendungen und Umtausch",
    "legal.returns.subtitle": "Flexible Rückgabepolitik von Equi Saddles. Ihre Zufriedenheit ist unsere Priorität.",
    "legal.delivery.title": "Lieferung und Versand",
    "legal.delivery.subtitle": "Sicherer Versand Ihrer Reitsättel in ganz Europa.",
    "legal.customerService.title": "Exzellenter Kundenservice",
    "legal.customerService.subtitle": "Bei Equi Saddles ist Ihre Zufriedenheit unsere Mission.",
